...
class ListRecipeTypeAdapter(
    private val listener: RecipeClickListener,
    private val recipeList: List<Recipe?>,
) :
    RecyclerView.Adapter<ListRecipeTypeAdapter.ListRecipeTypeViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListRecipeTypeViewHolder {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.list_type_recipe, parent, false)
        return ListRecipeTypeViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: ListRecipeTypeViewHolder, position: Int) {
    ...
    class ListRecipeTypeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
